<?php
	...
	if(isset($_POST["today_date_report"])){
		...
		if($result){
			...
			$output .="<tr></tr><tr><tr><tr style='background:blue;style='color:white;'><td colspan='3' style='color:white;'><h3>".$lang["total_amount"]."</h3></td><td style='text-align: center;color:white;'><h3>".$result["total"]["total_amount"]."</h3></td><td colspan='2' style='color:white;'><h2>".$lang["total_price"]."</h3></td><td style='text-align: center;color:white;'><h3>".$result["total"]["total_price"]."</h3></td></tr>";
			$output .="</tbody></table>";
